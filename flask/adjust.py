...
#create 8x8 coposition image 
#image_enhanced = image.filter(ImageFilter.EDGE_ENHANCE_MORE)
#image_8x8 = image_enhanced.resize([8,8],Image.ANTIALIAS)
